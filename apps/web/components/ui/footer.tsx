    ...
    <footer>
        ...
        >
          ...
          <div className="space-y-2 sm:col-span-12 lg:col-span-4">
            ...
            <div className="text-sm text-gray-600">
              &copy; MyWebDrive - All rights reserved.
            </div>
          </div>
          ...
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="flex gap-1">
              <li>
                <Link
                  className="flex items-center justify-center text-brand-primary-500 transition hover:text-brand-primary-600"
                  href="#0"
                  aria-label="Twitter"
                >
                  <svg
      ...
      <div className="relative -mt-16 h-60 w-full" aria-hidden="true">
        ...
        <div
          ...
          aria-hidden="true"
        >
          <div className="h-56 w-56 rounded-full border-[20px] border-brand-primary-700 blur-[80px]"></div>
        </div>
      </div>
    </footer>
  );
