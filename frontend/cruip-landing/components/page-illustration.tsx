  ...
  return (
    <>
      ...
      <div
        ...
        aria-hidden="true"
      >
        <div className="h-80 w-80 rounded-full bg-gradient-to-tr from-brand-primary-500/40 to-transparent opacity-50 blur-[120px]" />
      </div>
      <div
        className="pointer-events-none absolute left-1/2 top-[420px] ml-[380px] -translate-x-1/2"
        aria-hidden="true"
      >
        <div className="h-80 w-80 rounded-full bg-gradient-to-tr from-brand-primary-500/30 to-brand-accent-500/20 opacity-40 blur-[140px]" />
      </div>
      <div
        className="pointer-events-none absolute left-1/2 top-[640px] -ml-[300px] -translate-x-1/2"
        aria-hidden="true"
      >
        <div className="h-80 w-80 rounded-full bg-gradient-to-tr from-brand-accent-500/30 to-gray-900 opacity-40 blur-[140px]" />
      </div>
    </>
  );
}
