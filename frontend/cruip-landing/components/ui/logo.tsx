...
export default function Logo() {
  return (
    <Link href="/" className="inline-flex items-center gap-2" aria-label="MyWebDrive">
      <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
        <path
          className="fill-nothing-display"
          fillRule="evenodd"
        ...
        />
        <path
          className="fill-nothing-secondary"
          fillRule="evenodd"
      ...
      <span className="font-nothing-head text-base font-semibold text-nothing-display">
        MyWebDrive
      </span>
    </Link>
  );
